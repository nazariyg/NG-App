...
public final class SplashScreenScene: UIInitialScene {
    ...
    public init() {
        DispatchQueue.syncSafeOnMain {
            components.view =
                InstanceService.shared.instance(for: SplashScreenViewProtocol.self, defaultInstance: SplashScreenView())
            ...
            workerQueueScheduler.schedule { [components, _sceneIsInitialized, disposeBag] in
                components.interactor =
                    InstanceService.shared.instance(
                        for: SplashScreenInteractorProtocol.self,
                        defaultInstance: SplashScreenInteractor(workerQueueScheduler: workerQueueScheduler))
                components.presenter =
                    InstanceService.shared.instance(
                        for: SplashScreenPresenterProtocol.self,
                        defaultInstance: SplashScreenPresenter(workerQueueScheduler: workerQueueScheduler))
                components.router =
                    InstanceService.shared.instance(for: SplashScreenRouterProtocol.self, defaultInstance: SplashScreenRouter())
    ...
    struct WorkerQueueSchedulerWiring {
        ...
        struct ViewEvents {
            let events: O<SplashScreenView.Event>
        }

        let interactorGo: O<Void>
        let viewOnMainScheduler: O<SplashScreenViewProtocol>
        ...
        var interactor: (events: O<SplashScreenInteractor.Event>, requests: O<SplashScreenInteractor.Request>) {
            let events =
        ...
        var presenter: (events: O<SplashScreenPresenter.Event>, requests: O<SplashScreenPresenter.Request>) {
            let events =
        ...
        func biBind<BiBindableType: BiBindable>(
            _ variable: V<BiBindableType.Element>, toView viewPropertyKeyPath: KeyPath<SplashScreenViewProtocol, BiBindableType>, disposeBag: DisposeBag) {
